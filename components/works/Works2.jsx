  ...
  return (
    <>
      ...
      {/* <ul className="mt-[40px] flex w-full justify-start md:justify-end flex-wrap font-medium pb-12">
        ...
        <li
          className={`${test === "Video" ? "text-[#FA5252]" : "fillter-btn"
            } mr-4 md:mx-4`}
        ...
        <li
          className={`${test === "Web Design" ? "text-[#FA5252]" : "fillter-btn"
            } mr-4 md:mx-4`}
      ...
      >
        {data.map((item) => (
          ...
          <div
            ...
            style={{
              background: `${theme === "dark" ? "white" : item?.bg}`,
              boxShadow: `${theme === "dark" ? "transparent" : '0px 4px 20px rgb(0 0 0 / 8%)'}`,
            }}
            key={item.id}
          ...
          >
            <Link href={item.link} target="_blank">
              ...
              <h2
                ...
                //   color: "black"
                // }}
                className="font-medium cursor-pointer text-xl duration-300 transition hover:text-[#FA5252] dark:hover:text-[#FA5252] dark:text-black mt-2">
                {item.title}
              </h2>
            </Link>
          </div>
